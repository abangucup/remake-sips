{{-- Modal Hapus --}}
<div id="hapusData-{{ $jenis->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapusData"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('jenis-kenderaan.destroy', $jenis->id) }}" method="post">
                @csrf
                @method('DELETE')
