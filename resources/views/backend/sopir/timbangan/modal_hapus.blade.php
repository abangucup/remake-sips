{{-- Modal Hapus --}}
<div id="hapusData-{{ $timbangan->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapusData"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('timbangan.destroy', $timbangan->id) }}" method="post">
                @csrf
                @method('DELETE')
