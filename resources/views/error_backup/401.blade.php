...
@section('title', '401 - Authentication')
...
<div class="card-body">
    ...
    <div class="text-center">
        <p class="mt-3 mb-4 text-center text-muted f-16">Permintaan memerlukan otentikasi. <br>
            Silakan masukkan kredensial yang valid untuk mengakses sumber daya ini.</p>
