...
CREATE TABLE `kenderaans` (
  ...
  CONSTRAINT `kenderaans_jenis_id_foreign` FOREIGN KEY (`jenis_id`) REFERENCES `jenis` (`id`)
...
CREATE TABLE `pelanggans` (
  ...
  CONSTRAINT `pelanggans_tarif_id_foreign` FOREIGN KEY (`tarif_id`) REFERENCES `tarifs` (`id`),
...
INSERT INTO `pelanggans` VALUES (2,10,23,8,'#L10P02B3','2023-11-23 09:56:43','2023-11-23 09:56:43'),(4,10,25,2,'#LP1CAF','2023-11-25 04:50:03','2023-11-25 10:15:58');
...
CREATE TABLE `pengelolas` (
  ...
  CONSTRAINT `pengelolas_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `sampahs` (
  ...
  CONSTRAINT `sampahs_kategori_id_foreign` FOREIGN KEY (`kategori_id`) REFERENCES `kategoris` (`id`)
...
INSERT INTO `sampahs` VALUES (1,2,'Kertas UBah',123,'2023-11-24','2023-11-24 09:37:09','2023-11-24 09:41:45'),(3,2,'Plastik',20,'2023-11-17','2023-11-24 12:38:05','2023-11-24 12:38:05');
...
CREATE TABLE `sopirs` (
  ...
  CONSTRAINT `sopirs_kenderaan_id_foreign` FOREIGN KEY (`kenderaan_id`) REFERENCES `kenderaans` (`id`),
